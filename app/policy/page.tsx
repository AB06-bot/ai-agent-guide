...
export default function PolicyPage() {
  const articles = getArticlesByCategory("Policy")
  ...
  return (
    <div className="min-h-screen bg-white text-black">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        <div className="mb-12">
          <h1 className="text-4xl font-bold mb-4">Policy</h1>
          <p className="text-lg text-neutral-600">How governments and institutions are shaping AI agent governance.</p>
        </div>
